...
1. **When opened, the app shows the list of IP addresses currently viewing the application**
2. **When a new user opens the app, the app dynamically adds their IP address to the list of IPs without a full page refresh.**
3. **When a user closes the app, the app dynamically removes their IP address from the list of IPs without a full page refresh.**
